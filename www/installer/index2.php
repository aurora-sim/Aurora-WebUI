...
<div>
    ...
    <form action="<?= SYSURL?>" method="post" name="dbdata">
  ...
  <?php } ?>
        ...
        <tr>
          <td class='right'><input id="submit" type="submit" name="back" value="Précédent" OnClick="history.go( -1 );return true;"></td>
            <td class='left'><input id="submit" type="submit" name="submitBtn" value="<?= SYSNAME?>">
          </td>
        </tr>
