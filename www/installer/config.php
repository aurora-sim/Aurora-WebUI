...
##################### System #########################
define("SYSNAME", "Aurora-WebUI");
define("SYSURL", "http://localhost/");
define("SYSMAIL", "infos@aurora-sim.org");
define("WIREDUX_SERVICE_URL", "http://your.webui.com:8007/WIREDUX");
define("WIREDUX_TEXTURE_SERVICE", "http://your.webui.com:8002");
...
################### Help support area #####################
$support_emails_to = "digitalconcepts@free.fr";
$support_emails_subject = "DigiGrids Support:";
...
define("C_DB_NAME", "orora");
//Your Username from Database here:
define("C_DB_USER", "test");
//Your Database Password here:
define("C_DB_PASS", "test");
