...
<div id="content">
  ...
  <tr>
	...
	<tr>
		...
		<td class='left'><input id="sysurl" name="SYSURL" value="<?= 'http://localhost/'?>"></td>
	</tr>
	
	<tr>
		<td class='right'></td>
		<td class='left_exemple'>http://your.webui.com/ (avec / à la fin!)</td>
	</tr>
	...
	<tr><td class='infos' colspan='2'>Aurora-Webui : Configuration de la base de données</td></tr>

	<tr>
		<td class='right'><label for="dbtype">Type de base: </label></td>
		<td class='left'><input id="dbtype" name="C_DB_TYPE" value="mysql"></td>
	</tr>
	
	<tr>
		<td class='right'><label for="dbhost">DB Hôte : </label></td>
		<td class='left'><input id="dbhost" name="C_DB_HOST" value="localhost"></td>
	</tr>
	
	<tr>
		<td class='right'><label for="dbname">Nom de la base: </label></td>
		<td class='left'><input id="dbname" name="C_DB_NAME" value="orora"></td>
	</tr>
	
	<tr>
		<td class='right'><label for="dbuser">Utilisateur : </label></td>
		<td class='left'><input id="dbuser" name="C_DB_USER" value="<?= test?>"></td>
	</tr>
	
	<tr>
		<td class='right'><label for="dbpass">Mot de passe : </label></td>
	...
	<tr>
		<td class='center' colspan='2'><input id="submit" type="submit" name="submitBtn" value="Suivant"></td>
	</tr>
