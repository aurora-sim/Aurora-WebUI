...
CREATE TABLE IF NOT EXISTS `wi_useraccounts` (
...
('Albania'), ('Belgium'), ('Bosnia'), ('Bulgaria'), ('Germany'), ('Denmark'), ('Estonia'), ('Finland'),
('France'), ('Georgia'), ('Greece'), ('United Kingdom'), ('Ireland'), ('Iceland'), ('Italy'), ('Croatia'),
('Latvia'), ('Lithuania'), ('Luxembourg'), ('Malta'), ('Macedonia'), ('Moldova'), ('Netherlands'), ('Norway'),
('Poland'), ('Portugal'), ('Romania'), ('Russia'), ('Sweden'), ('Switzerland'), ('Serbia & Montenegro'),
('Slovakia'), ('Slovenia'), ('Espana'), ('Czech Rep.'), ('Turkey'), ('Ukraine'), ('Hungary'), ('Belarus'),
('Cyprus'), ('Austria'), ('Afghanistan'), ('Armenia'), ('Azerbaijan'), ('Bangladesh'), ('Bhutan'), ('Brunei'),
('India'), ('Indonesia'), ('Japan'), ('Cambodia'), ('Kazakhstan'), ('Kyrgyzstan'), ('Laos'), ('Malaysia'),
('Maldives'), ('Mongolia'), ('Myanmar'), ('Nepal'), ('North Korea'), ('Pakistan'), ('Philippines'),
('Singapore'), ('Sri Lanka'), ('South Korea'), ('Tajikistan'), ('Taiwan'), ('Thailand'), ('Turkmenistan'),
('Uzbekistan'), ('Viet Nam'), ('Canada'), ('Mexico'), ('USA'), ('Antigua und Barbuda'), ('Aruba'),
('Bahamas'), ('Barbados'), ('Belize'), ('Bermuda'), ('Cayman Islands'), ('Costa Rica'), ('Curacao'),
('Dominica'), ('Dominican Rep.'), ('El Salvador'), ('Grenada'), ('Guadeloupe'), ('Guatemala'), ('Haiti'),
('Honduras'), ('Jamaica'), ('Virgin Islands'), ('Cuba'), ('Martinique'), ('Nicaragua'), ('Panama'),
('Puerto Rico'), ('St. Kitts und Nevis'), ('St. Lucia'), ('St. Maarten'), ('St. Vincent & Grenadin'),
('Trinidad & Tobago'), ('Argentina'), ('Bolivia'), ('Brazil'), ('Chile'), ('Ecuador'), ('Guyana'),
('Colombia'), ('Paraguay'), ('Peru'), ('Suriname'), ('Uruguay'), ('Venezuela'), ('Australia'), ('Fiji'),
('Marshall Islands'), ('Micronesia'), ('Nauru'), ('New Zealand'), ('Palau'), ('Papua New Guinea'),
('Samoa'), ('Tonga'), ('Tuvalu'), ('Vanuatu'), ('Bahrain'), ('Iraq'), ('Iran'), ('Israel'), ('Yemen'),
('Jordan'), ('Quatar'), ('Kuwait'), ('Lebanon'), ('Oman'), ('Palestinian authority'), ('Saudi Arabia'),
('Syria'), ('U.A.E.'), ('Algeria'), ('Angola'), ('Benin'), ('Botswana'), ('Burkina Faso'), ('Burundi'),
('Dem. Rep. of the Congo'), ('Djibouti'), ('Céte d''Ivoire'), ('Eritrea'), ('Gabun'), ('Gambia'), ('Ghana'),
('Guinea'), ('Guinea-Bissau'), ('Cameroon'), ('Cape Verde'), ('Kenya'), ('Lesotho'), ('Liberia'), ('Libya'),
('Madagascar'), ('Malawi'), ('Mali'), ('Morocco'), ('Mauritania'), ('Mauritius'), ('Mozambique'), ('Namibia'),
('Niger'), ('Nigeria'), ('Dem. Rep. of the Congo'), ('Zambia'), ('Sao Tomé and Principe'), ('Senegal'),
('Seychelles'), ('Sierra Leone'), ('Simbabwe'), ('Somalia'), ('Sudan'), ('Swaziland'), ('South Africa'),
('Tanzania'), ('Togo'), ('Chad'), ('Tunisia'), ('Uganda'), ('Central African Rep.'), ('Egypt'),
('Guinea Equatorial'), ('Ethiopia'), ('La Réunion'), ('Solomon Islands'), ('French Guiana');


INSERT INTO `wi_lastnames` (`name`, `active`) VALUES 
('Binder', '1'), ('Noel', '1'), ('Young', '1'), ('Roux', '1'), ('Allen', '1'), ('Heron', '1'),
('Mansworld', '1'), ('Babbi', '1'), ('Crazys', '1'), ('Linden', '1'), ('Machlam', '1'), ('Notringham', '1'),
('Opus', '1'), ('Hausermann', '1'), ('McLachlan', '1'), ('McKinsey', '1'), ('Pohl', '1'),
('Schwarzenegger', '1'), ('Mueller', '1'), ('Nosemann', '1'), ('Obolus', '1'), ('Himbaer', '1'),
('Nala', '1'), ('Kandee', '1'), ('Bauer', '1'), ('Simons', '1'), ('Raptor', '1'), ('Maek', '1'),
('Huss', '1'), ('Mondial', '1'), ('Moondancer', '1'), ('Sweetheart', '1'), ('Schnuggy', '1'),
('Swindlehurst', '1'), ('Baumeister', '1'), ('Bloomberg', '1'), ('Dredd', '1'), ('Gridlock', '1'),
('Bohlen', '1'), ('Snapper', '1'), ('Tickle', '1'), ('Ewing', '1'), ('Schwinge', '1'), ('Nonsito', '1');
...
('1', '1', 'yellow',
'Info: System Works very well!',
'Today we''ve built a new loginscreen info system and it works very well. You can now see Info windows on the startup screen.');


INSERT INTO `wi_startscreen_news` (`id`, `title`, `message`, `time`)VALUES
(1, '[COMPLETE] The new loginscreen is done and works fine so far',
'<P>We built a new loginscreen which will inform you about Grid updates or changes. 
Also you can now see how many users and regions are online, and more. 
Also, you may from time to time see an infowindow, which informs you about important news. Have Fun !</P>', 1211321439);


INSERT INTO `wi_gallery` (`picture`, `picturethumbnail`, `description`, `active`, `rank`) VALUES
('image1.jpg', 'thumbnail1.jpg', 'Image of our world', '1', '1'),
('image2.jpg', 'thumbnail2.jpg', 'Image of our world', '1', '1'),
('image3.jpg', 'thumbnail3.jpg', 'Image of our world', '1', '1'),
('image4.jpg', 'thumbnail4.jpg', 'Image of our world', '1', '1'),
('image5.jpg', 'thumbnail5.jpg', 'Image of our world', '1', '1');
