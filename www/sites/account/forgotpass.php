...
{
    $found = array();
    $found[0] = json_encode(array('Method' => 'ConfirmUserEmailName',
    ...
    if ($recieved->{'Verified'} == "true") 
    {
        ...
        //-----------------------------MAIL END --------------------------------------
        echo "<script language='javascript'><!-- window.alert('Check your email.'); window.location.href='/index.php?page=login&btn=9'; // --></script>";
    }

    else
    {
        if ($recieved->{'Error'} != "") {echo "<script language='javascript'><!-- alert(\"" . $recieved->{'Error'} . "\"); // --></script>";}
        else {echo "<script language='javascript'><!-- alert(\"Unknow error. Please try again later.\"); // --> </script>";}
    }
}
?>
                ...
                <table>
                    <tr>
                        ...
                        <td class="even" width="50%">
                            <div class="roundedinput"><input id="forgot_pass_input" name="name" type="text" size="40" maxlength="50" value="<?php echo $_POST[name]; ?>"></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="odd">
                            <div class="roundedinput"><input id="forgot_pass_input" name="email" type="text" size="40" maxlength="50" value="<?php echo $_POST[email]; ?>"></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        ...
                        <td class="even">
                            <div class="roundedinput"><input id="forgot_pass_input" name="email2" type="text" size="40" maxlength="50" value="<?php echo $_POST[email2]; ?>"></div>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td class="odd"></td>
                        <td class="odd">
                            <div class="center"><input type="hidden" name="action" value="check"><button id="forgot_pass_bouton" name="Submit" type="Submit"><?php echo $webui_submit; ?></button></div>
                        </td>
                    </tr>
                </table>
            </form>
