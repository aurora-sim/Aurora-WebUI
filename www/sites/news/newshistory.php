<table 	width="100%" height="100%" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF">
  <tr>
    <td bgcolor="#336EB2" valign="top"><table width="100%" cellpadding="2" cellspacing="0" border="0">
      <tr>
        <td colspan="2" bgcolor="#1F5BA1">
        <div align="center">
        <font color="#FFFFFF" class="style2"><b>
        <font size="3">News History </font>
        <br /><br /></b></font></div></td>
        </tr>
      <?
