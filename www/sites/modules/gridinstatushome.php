...
<div id="gridstatus1"><? echo $webui_grid_status; ?>: <? if($GRIDSTATUS){ ?><span class=online><? echo $webui_grid_status_online; ?></span><? } else { ?><span class=offline><? echo $webui_grid_status_offline; ?></span><? } ?></div>
<div id="gridstatus2"><? echo $webui_total_users; ?>: <?=$USERCOUNT?></div>
<div id="gridstatus3"><? echo $webui_total_regions; ?>: <?=$REGIONSCOUNT?></div>
<div id="gridstatus4"><? echo $webui_unique_visitors; ?>: <?=$LASTMONTHONLINE?></div>
<div id="gridstatus5"><strong><a href="index.php?page=onlineusers"><? echo $webui_online_now; ?></a>: <?=$NOWONLINE?></strong></div>