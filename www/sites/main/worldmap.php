...
<style type="text/css">#map-container {width: 100%; height: 380px;}</style>
...
<div id="content">
    ...
    <div id="ContentHeaderRight">
        <h5><a onClick="window.open('<?php echo SYSURL; ?>map/index.php','mywindow')" style="cursor:pointer; float:right; display:inline-block;"><?php echo $webui_fullscreen; ?></a></h5>
    </div>
    <div class="clear"></div>
