...
<div id="annonce10">
    ...
    <tr>
		<td>
			<p><b><?php echo $count ?> <?php echo $webui_users_found ?></b></p>
        </td>
        <td>
            ...
            <tr>
				<td>
                    ...
                    <img SRC=images/icons/icon_back_more_<?php if (0 > ($AStart - $ALimit)) echo off; else echo on ?>.gif WIDTH=15 HEIGHT=15 border="0" /></a>
                </td>
                ...
                <td>
                    ...
                    <img SRC=images/icons/icon_forward_one_<?php if ($count <= ($AStart + $ALimit)) echo off; else echo on ?>.gif WIDTH=15 HEIGHT=15 border="0" /></a>
                </td>
				...
				<td>
                    ...
                    <img SRC=images/icons/<?php if ($ALimit != 50) echo icon_limit_50_on; else echo icon_limit_off; ?>.gif WIDTH=15 HEIGHT=15 border="0" ALT="Limit 50" /></a>
                </td>

                <td>
					<a href="<?php echo $LinkAusgabe ?>AStart=0&amp;ALimit=100&amp;" target="_self">
                    <img SRC=images/icons/<?php if ($ALimit != 100) echo icon_limit_100_on; else echo icon_limit_off; ?>.gif WIDTH=15 HEIGHT=15 border="0" ALT="Limit 100" /></a>
				</td>
            </tr>
			</table>
			</div>
