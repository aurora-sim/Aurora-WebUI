...
<div id="content">
    <h2><?= SYSNAME ?>: <? echo $webui_home; ?></h2>
    <? echo $webui_welcome_visitor; ?>
    <!--[if lt IE 8]>
      <div id="alert">Hummm, You should upgrade your copy of Internet Explorer.</div>
    <![endif]-->
    <h1><? echo $webui_welcome; ?> <?= SYSNAME ?></h1>
    <? echo $webui_home_page; ?>
    
<div id="gallery_slideshow">
	<a href="#" class="show">
		<img src="<?= SYSURL ?>images/gallery/image1thumbnail.jpg" width="169" height="169" title="" alt="<?= SYSNAME ?>" rel="<h3><?= SYSNAME ?></h3><? echo $webui_slideshow_comment01; ?>" />
	</a>
	
	<a href="#">
		<img src="<?= SYSURL ?>images/gallery/image2thumbnail.jpg" width="169" height="169" title="" alt="<?= SYSNAME ?>" rel="<h3><?= SYSNAME ?></h3><? echo $webui_slideshow_comment02; ?>" />
	</a>
	
	<a href="#">
		<img src="<?= SYSURL ?>images/gallery/image3thumbnail.jpg" width="169" height="169" title="" alt="<?= SYSNAME ?>" rel="<h3><?= SYSNAME ?></h3><? echo $webui_slideshow_comment03; ?>" />
	</a>

	<a href="#">
		<img src="<?= SYSURL ?>images/gallery/image4thumbnail.jpg" width="169" height="169" title="" alt="<?= SYSNAME ?>" rel="<h3><?= SYSNAME ?></h3><? echo $webui_slideshow_comment04; ?>" />
	</a>
	
	<a href="#">
		<img src="<?= SYSURL ?>images/gallery/image5thumbnail.jpg" width="169" height="169" title="" alt="<?= SYSNAME ?>" rel="<h3><?= SYSNAME ?></h3><? echo $webui_slideshow_comment01; ?>" />
	</a>
